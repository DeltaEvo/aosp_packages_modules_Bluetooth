...
L2capSecurityModuleInterface::L2capSecurityModuleInterface(
        internal::SecurityManagerImpl* security_manager_impl, os::Handler* security_handler)
...
void L2capSecurityModuleInterface::Enforce(
  ...
  this->security_handler_->Post(common::BindOnce(
          ...
          common::Unretained(security_manager_impl_), std::forward<hci::AddressWithType>(remote),
          std::forward<l2cap::classic::SecurityPolicy>(policy),
          std::forward<l2cap::classic::SecurityEnforcementInterface::ResultCallback>(
                  result_callback)));
}
...
void L2capSecurityModuleInterface::Enforce(
  ...
  this->security_handler_->Post(common::BindOnce(
          &internal::SecurityManagerImpl::EnforceLeSecurityPolicy,
          common::Unretained(security_manager_impl_), std::forward<hci::AddressWithType>(remote),
          std::forward<l2cap::le::SecurityPolicy>(policy),
