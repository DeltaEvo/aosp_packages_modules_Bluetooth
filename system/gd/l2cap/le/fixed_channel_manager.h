...
public:
   ...
   */
  bool ConnectServices(hci::AddressWithType address_with_type,
   ...
   * - After a service is registered, any LE ACL connection will create a FixedChannel object that
   * is delivered through on_open_callback
