...
TEST(LEConnectionMetricsRemoteDeviceTest, Initialize) { ASSERT_EQ(0, 0); }
...
TEST(LEConnectionMetricsRemoteDeviceTest, ConnectionSuccess) {
  ...
  argument_list.push_back(
          std::make_pair(os::ArgumentType::ACL_STATUS_CODE,
  ...
  MockMetricsCollector::GetLEConnectionMetricsCollector()->AddStateChangedEvent(
          address1, LeConnectionOriginType::ORIGIN_NATIVE, LeConnectionType::CONNECTION_TYPE_LE_ACL,
          LeConnectionState::STATE_LE_ACL_START, argument_list);

  MockMetricsCollector::GetLEConnectionMetricsCollector()->AddStateChangedEvent(
          address1, LeConnectionOriginType::ORIGIN_NATIVE, LeConnectionType::CONNECTION_TYPE_LE_ACL,
          LeConnectionState::STATE_LE_ACL_END, argument_list);
...
TEST(LEConnectionMetricsRemoteDeviceTest, Cancellation) {
  ...
  MockMetricsCollector::GetLEConnectionMetricsCollector()->AddStateChangedEvent(
          empty_address, LeConnectionOriginType::ORIGIN_NATIVE,
          LeConnectionType::CONNECTION_TYPE_LE_ACL, LeConnectionState::STATE_LE_ACL_CANCEL,
          argument_list);

  // Ending of the LE-ACL Connection
  MockMetricsCollector::GetLEConnectionMetricsCollector()->AddStateChangedEvent(
          address1, LeConnectionOriginType::ORIGIN_NATIVE, LeConnectionType::CONNECTION_TYPE_LE_ACL,
          LeConnectionState::STATE_LE_ACL_END, no_connection_argument_list);
...
TEST(LEConnectionMetricsRemoteDeviceTest, Timeout) {
  ...
  MockMetricsCollector::GetLEConnectionMetricsCollector()->AddStateChangedEvent(
          address1, LeConnectionOriginType::ORIGIN_NATIVE, LeConnectionType::CONNECTION_TYPE_LE_ACL,
          LeConnectionState::STATE_LE_ACL_TIMEOUT, argument_list);
