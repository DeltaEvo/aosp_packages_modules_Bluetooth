...
bt_status_t MockCoreInterface::toggleProfile(tBTA_SERVICE_ID /* service_id */, bool /* enable */) {
  return BT_STATUS_SUCCESS;
}

void MockCoreInterface::removeDeviceFromProfiles(const RawAddress& /* bd_addr */) {}

void MockCoreInterface::onLinkDown(const RawAddress& /* bd_addr */, tBT_TRANSPORT /* transport */) {
}
