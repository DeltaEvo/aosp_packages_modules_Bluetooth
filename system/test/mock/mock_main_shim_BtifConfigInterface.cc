...
bool bluetooth::shim::BtifConfigInterface::HasSection(const std::string& /* section */) {
  return false;
}
bool bluetooth::shim::BtifConfigInterface::HasProperty(const std::string& /* section */,
...
size_t bluetooth::shim::BtifConfigInterface::GetBinLength(const std::string& /* section */,
                                                          const std::string& /* key */) {
  return 0;
}
...
bool bluetooth::shim::BtifConfigInterface::RemoveProperty(const std::string& /* section */,
                                                          const std::string& /* key */) {
  return false;
}
