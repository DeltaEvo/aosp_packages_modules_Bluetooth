...
/**
 * Class to contain all the info about the items of the Map Email Settings Menu. It can be used for
...
public class BluetoothMapAccountItem implements Comparable<BluetoothMapAccountItem> {
    ...
    private BluetoothMapAccountItem(
            String id,
            String name,
            String packageName,
            String authority,
            Drawable icon,
            BluetoothMapUtils.TYPE appType,
            String uci,
            String uciPrefix) {
        this.mName = name;
        this.mIcon = icon;
    ...
    public static BluetoothMapAccountItem create(
            String id,
            String name,
            String packageName,
            String authority,
            Drawable icon,
            BluetoothMapUtils.TYPE appType) {
        return new BluetoothMapAccountItem(
                id, name, packageName, authority, icon, appType, null, null);
    }
    ...
    public static BluetoothMapAccountItem create(
            ...
            String uciPrefix) {
        return new BluetoothMapAccountItem(
                id, name, packageName, authority, icon, appType, uci, uciPrefix);
    }
    ...
    public int compareTo(BluetoothMapAccountItem other) {
        ...
        if (!other.mPackageName.equals(this.mPackageName)) {
            Log.v(TAG, "Wrong packageName : " + this.mPackageName + " vs " + other.mPackageName);
            return -1;
        }
